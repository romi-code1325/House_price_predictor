...
def _inject_login_css():
    st.markdown("""
        ...
        .hero-tick { font-size: 0.92rem; opacity: 0.9; margin-bottom: 0.35rem; }
        ...
        .form-title { font-size: 2rem; font-weight: 800; margin-bottom: 0.3rem; }
        .form-caption { color: #6b7280; margin-bottom: 1.6rem; }
    ...
    with left:
        st.markdown("""
            <div class="hero-panel">
                ...
                <div class="hero-tick">✓ Instant price predictions</div>
                <div class="hero-tick">✓ Interactive location map</div>
                <div class="hero-tick">✓ Your prediction history saved</div>
            </div>
        """, unsafe_allow_html=True)
